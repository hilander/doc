...
\indent
  ...
  \begin{itemize}
    \item \code{coroutine} jest podstawową klasą dla każdego włókna: dzięki niej włókno posiada swój własny kontekst wykonania -- dzięki temu można zapamiętać miejsce,
...
%
\indent
  Kolejne rozdziały podają bardziej szczegółowy opis każdego elementu \code{libmixed}.
\par
\newpage
