...
\indent
	...
	\emph{hybrydowymi}. Użytkownik jest odpowiedzialny za zarządzanie włóknami, zaś system operacyjny może udostępniać mu pewne mechanizmy
  pomocne w~zarządzaniu wątkami hybrydowymi (np. opisany w~rozdziale \ref{sec:system} mechanizm wywłaszczania włókien lub dedykowana dla włókien obsługa
