...
%
\indent
	Wątki przestrzeni jądra i~wątki przestrzeni użytkownika posiadają zarówno zalety jak i~wady:
  \begin{center}
  \begin{tabular}{|c|p{4cm}|p{4cm}|} \hline
                & Wątki przestrzeni jądra & wątki przestrzeni użytkownika \\ \hline
      Zalety    & & \\ \hline
      Wady      & & \\ \hline
  \end{tabular}
  \end{center}
