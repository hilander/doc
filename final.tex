...
%
\indent
  Procesy, jakie może uruchomić użytkownik, działać będą w~\emph{przestrzeni użytkownika} (ang. \emph{user space}), zaś
...
\indent
  ...
  przestrzeni adresowej pierwszego procesu na przestrzeń adresową drugiego. Ze względu na 
\par
%
\subsection{Wątki}
\indent
