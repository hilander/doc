...
\par
\indent
  Biblioteka jest napisana w~języku C++, została stworzona z~myślą o~Linuksie i~wykorzystuje mechanizm \code{epoll}.
  \code{Epoll}, w~odróżnieniu od znanego ze specyfikacji POSIX 
\par
\indent
