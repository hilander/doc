...
\indent
  ...
  Umożliwia to bardziej efektywne wykorzystanie czasu procesora, gdyż może on być wykorzystany do wykonania kawałka pewnego programu,
  podczas gdy inny program oczekuje na wykonanie przez system operacyjny pewnego zadania (często związanego z~
  Obecnie większość dostępnych komputerów to maszyny wieloprocesorowe (\emph{wielordzeniowe}, ang. \emph{multi\ppauza core}), a~więc umożliwiają
  \emph{równoległe} (ang. \emph{parallel}) wykonanie programów. W~wypadku nowoczesnych systemów operacyjnych, wielo
\par
%
\indent
