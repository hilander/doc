...
%
\indent
  Rozdział \ref{sec:fibers} opisuje procesy, wątki oraz włókna.
\par
%
\begin{comment}
\indent
...
\indent
  ...
  w~odróżnieniu od pozostałych dwóch, działają zarówno w~superkomputerach jak i~w~stacjach roboczych. Dlatego też zadecydowałem o~zaimplementowaniu biblioteki korzystającej
...
\indent
    ...
    procesy, wątki, włókna. Dodatkowo, opisane są mechanizmy używane do zarządzania oraz komunikacji pomiędzy nimi, jak również problemy
...
\indent
  ...
  W~związku ze znacznym spadkiem wydajności tych systemów, zrezygnowano z~udostępniania włókien w~tych systemach.
