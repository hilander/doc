...
\par
\indent
  Każda składowa biblioteki działa w~jednej z~warstw:
  \begin{enumerate}
    \item Systemowej, w~której następuje analiza dostępnych zasobów systemowych, a~następnie są one rozdzielane pomiędzy wytworzone
      jednostki wykonawcze zarządzające włóknami.
...
\end{center}
\indent
	Biblioteka \code{libmixed} udostępnia użytkownikowi interfejs włókien, jak również system nimi zarządzający.
  Rysunek \arabic{libmixedoverview} przedstawia zależności pomiędzy klasami biblioteki. Najważniejsze dwie klasy z~punktu widzenia użytkownika
  to:
  \begin{enumerate}
...
\indent
\myownfigure{nullfork}{nullfork.png}{Wykres porównawczy dla testu \code{nullfork}}{.65} 
\par
\indent
...
\indent
\myownfigure{yield}{yield1n.png}{Wykres porównawczy dla testu \code{yield}}{.65} 
\par
\indent
\myownfigure{yieldLog}{yield1nLog.png}{Wykres porównawczy dla testu \code{yield} -- czas wykonania w~skali logarytmicznej}{.65} 
\par
%
\indent
\myownfigure{yieldn10}{yieldn10.png}{Wykres porównawczy dla testu \code{yield}}{.65} 
\par
\indent
\myownfigure{yieldn10Log}{yieldn10Log.png}{Wykres porównawczy dla testu \code{yield} -- czas wykonania w~skali logarytmicznej}{.65} 
\par
%
\indent
\myownfigure{yieldn100}{yieldn100.png}{Wykres porównawczy dla testu \code{yield}}{.65} 
\par
\indent
\myownfigure{yieldn100Log}{yieldn100Log.png}{Wykres porównawczy dla testu \code{yield} -- czas wykonania w~skali logarytmicznej}{.65} 
\par
%
\newpage
