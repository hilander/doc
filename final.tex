...
\newcommand{\myownfigure}[4]{ \newcounter{#1} \setcounter{#1}{\value{figmain}} \addtocounter{figmain}{1} \begin{center} \label{fig:#1} \centering \includegraphics[scale=#4, angle=0]{#2}\\ Rysunek \arabic{#1}. #3. \end{center}}
...
\indent
  ...
  systemu).
  Wątek jest bytem zaleznym od procesu, a~proces posiada wiadomości o~każdym wątku.
