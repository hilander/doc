...
\indent
  ...
  dzięki której możliwe będzie korzystanie z~zasobów komputera. Abstrakcja ta jest zrealizowana jako zbiór \emph{usług} (ang. \emph{services}) OS.
...
\indent
  ...
  Procesy, jakie może uruchomić użytkownik, mają dostęp do podzbioru przestrzeni jądra -- \emph{przestrzeni użytkownika} (ang. \emph{user space}).
\par
%
\indent
