...
%
\indent
  Dokładny opis procesów można znaleźć w~\cite{silberschatz} (rozdział 4).
\par
%
\subsection{Wątki}
\indent
...
%
\indent
 Szczegółowy opis wyżej wymienionych rodzajów wątków można znaleźć w~\cite{silberschatz} (rozdział 5).
\par
%
...
%
\indent
  W~\cite{silberschatz} można znaleźć wyczerpujący opis sposobów synchronizacji procesów, jak również opis metod pozwalających zapobiec zakleszczeniom.
\par
%
\newpage
