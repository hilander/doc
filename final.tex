...
\par
\subsubsection{Podsumowanie testów wydajnościowych}
\indent
  ...
  \begin{enumerate}
    ...
    \item Przełączanie kontekstu pomiędzy wątkami zaimplementowane w~jądrze systemu Linux jest kilkakrotnie szybsze od przełączania pomiędzy kontekstami użytkownika,
      zaimplementowanymi w~operacjach \function{swapcontext}.
    \item Operacja \function{pthread\_yield} działa w~czasie kilkakrotnie szybciej niż operacja \function{swapcontext}.
