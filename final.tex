...
\indent 
	...
	\begin{itemize}
		...
		\item pamięć: przechowuje dane oraz programy. Pamięć w~tym kontekście jest z~natury ulotna (po wyłączeniu komputera,
			jej zawartości nie można odzyskać);
...
%
\indent
	Problemem, który jest naturalnie związany z~ILP jest również zachowanie oryginalnej chronologii wykonywania rozkazów (zapisu wyników
