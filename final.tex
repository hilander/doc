...
\indent
	...
	\begin{enumerate}
		...
		\end{itemize}
		\item Abstrakcja dla urządzeń wejścia\dywiz wyjścia (ang. \emph{jacketing}):
		\begin{itemize}
		...
		\end{itemize}
		\item Zasoby współdzielone i~synchronizacja wątków:
		\begin{itemize}
...
\indent
	...
	W~rozdziale 2 została zgrubnie opisana architektura szeroko dostępnego komputera klasy PC, zaś rozdział 3 opisuje podstawowe
	polityki oraz mechanizmy stosowane do równoległego uruchomienia aplikacji, jak również do ich dostępu do zasobów komputera.
\par
%
\indent
	Jak dotychczas, implementacja wątków mieszanych (zwanych również \emph{hybrydowymi}) była realizowana zarówno po stronie jądra,
	jak również po stronie użytkownika. Praca \cite{anderson} opisuje mechanizmy konieczne do implementacji wątków hybrydowych 
	zarówno w~przestrzeni jądra, jak i~w~przestrzeni użytkownika.
\par
%
\newpage
