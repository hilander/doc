...
\indent
  ...
  \emph{Tutaj się jeszcze wymyśla o~wątkach przestrzeni jądra i~użytkownika ;-)}
\begin{comment}
  Każdy wątek potrzebuje przede wszystkim czasu do wykonania. Zadanie przydziału czasu może być wykonywane przez:
  \begin{enumerate}
    \item Jądro systemu operacyjnego: 
  \end{enumerate}
\end{comment}
\par
%
...
\indent
  ...
  Rysunek \arabic{libmixeddeployment} przedstawia wykorzystanie wątków przez libmixed: każdy wątek ma odpowiadać jednemu rdzeniowi w~komputerze, dlatego nawet wątek główny
...
\indent
  ...
  Koprocedura jest uogólnieniem pojęcia procedury, co pokazuje Tabela \arabic{tabmain}.
    ...
    \end{center}
    Klasa \code{coroutine} jest implementacją koprocedury i~udostępnia .
