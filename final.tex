...
\indent
  ...
  \begin{enumerate}
    ...
    \item Użycie I/O
    \begin{enumerate}
      \item Gniazda sieciowe.
      \item Stoper (ang. \emph{timer}).
    \end{enumerate}
...
\indent
  ...
  \centering
\footnotesize{
  \begin{xtabular}{|c|l|l|} \hline
    \tablehead{\hline Lp & \multicolumn{1}{c|}{\code{libmixed}} & \multicolumn{1}{c|}{\code{Pthreads}} \\ }
    \tablelasthead{\hline Lp & \multicolumn{1}{c|}{\code{libmixed}} & \multicolumn{1}{c|}{\code{Pthreads}} \\ }
