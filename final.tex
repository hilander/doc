...
\par
\indent
  Biblioteka jest napisana w~języku C++. Wykorzystuje mechanizm spotykany jedynie w~systemie Linux: \code{epoll}: podobny do
  zawartego w~specyfikacji POSIX mechanizmu \code{poll}, służy do cyklicznego sprawdzania stanu zasobów systemu.
\par
\indent
